...
<template>
  ...
  >
    ...
    >
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4 sm:space-y-6">
        ...
        <div>
          <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-0 mb-3 sm:mb-4">
            <h4 class="text-xs sm:text-sm font-medium text-gray-700">Answer Options</h4>
            <button
              type="button"
              @click="addOption"
              ...
              <div class="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                ...
                <div class="flex items-center gap-2 sm:gap-3 ml-8 sm:ml-0">
                  ...
                  <label class="flex items-center cursor-pointer">
                    ...
                    />
                    <span class="ml-1.5 sm:ml-2 text-xs sm:text-sm text-gray-700">Correct</span>
                  </label>
      ...
      <div class="flex justify-end gap-2 sm:gap-3 pt-3 sm:pt-4 pb-4 sm:pb-5 px-4 sm:px-5 border-t bg-white shrink-0">
        <button
          type="button"
          @click="closeModal"
          :disabled="props.isLoading"
        ...
        >
          <span v-if="props.isLoading || isUploadingImage" class="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 animate-spin">
  ...
  >
    ...
    >
      <div class="mt-3 text-center">
        ...
        <h3 class="text-base sm:text-lg font-medium text-gray-900 mt-2">Delete Answer Option</h3>
        <p class="mt-2 text-xs sm:text-sm text-gray-500">
          Are you sure you want to delete this answer option? This action cannot be
          undone.
        </p>
