    ...
    >
      <div class="mt-3 text-center">
        ...
        <div class="mt-4 flex justify-center gap-2 sm:gap-3">
          <button
            @click="handleConfirm"
            class="bg-red-600 text-white hover:bg-red-700 px-3 sm:px-4 py-2 rounded-md text-xs sm:text-sm font-medium transition-colors duration-200"
          >
            Delete
          </button>
          <button
            @click="handleClose"
            class="bg-gray-300 text-gray-700 hover:bg-gray-400 px-3 sm:px-4 py-2 rounded-md text-xs sm:text-sm font-medium transition-colors duration-200"
          >
            Cancel
          </button>
        </div>
