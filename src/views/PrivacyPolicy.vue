      ...
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p class="text-gray-700 dark:text-gray-100 leading-relaxed mb-4">
            ...
            <a href="#table-of-contents" class="text-blue-600 underline">
              table of contents.
            </a>
          </p>
          ...
          <p class="text-gray-700 dark:text-gray-100 leading-relaxed mb-4">
            ...
            orientation, religious beliefs). We do <strong>not</strong> process
        ...
        >
          ...
          <ol class="list-decimal pl-6 text-gray-700 dark:text-gray-100 space-y-2 leading-relaxed">
            ...
            <li>
              <a href="#information-retention" class="text-blue-600 underline">
            ...
            <li>
              <a href="#minors-data" class="text-blue-600 underline">
            ...
            <li>
              <a href="#do-not-track" class="text-blue-600 underline">
                CONTROLS FOR DO-NOT-TRACK FEATURES
              </a>
            </li>

            <li>
              <a href="#regional-rights" class="text-blue-600 underline">
            ...
            <li>
              <a href="#student-anonymity" class="text-blue-600 underline">
                STUDENT ANONYMITY
              </a>
            </li>
            ...
            <li>
              <a href="#updates-to-notice" class="text-blue-600 underline">
                DO WE MAKE UPDATES TO THIS NOTICE?
              </a>
            </li>

            <li>
              <a href="#contact-about-notice" class="text-blue-600 underline">
        ...
        >
          ...
          <p class="text-gray-700 dark:text-gray-100 leading-relaxed">
            ...
            personal information by the third-party provider. Please review
            their privacy notice for details.
          </p>
        </div>
        ...
        >
          ...
          <p class="text-gray-700 dark:text-gray-100 leading-relaxed mb-2">
            ...
            accounting, or other legal requirements). No purpose will require us
            keeping your personal information longer than the period users have
            an account with us.
          </p>
        ...
        >
          ...
          <p class="text-gray-700 dark:text-gray-100 leading-relaxed">
            ...
            unauthorized parties will not access your information. Transmission
            to and from our Services is at your own risk. Access the Services
        ...
        >
          ...
          <p class="text-gray-700 dark:text-gray-100 leading-relaxed">
            ...
            at any time. You can withdraw your consent by contacting us using
        ...
        >
          ...
          <p class="text-gray-700 dark:text-gray-100 leading-relaxed mb-2">
            ...
            implementing rules and regulations. This Privacy Notice satisfies
          ...
          <p class="text-gray-700 dark:text-gray-100 leading-relaxed">
            ...
            breach of the Data Privacy Act to the National Privacy Commission
        ...
        >
          ...
          <p class="text-gray-700 dark:text-gray-100 leading-relaxed">
            ...
            not shared with unauthorized third parties. Uploaded files are
            encrypted and protected with access controls to prevent unauthorized
            access.
          </p>
        </div>
        ...
        >
          ...
          <p class="text-gray-700 dark:text-gray-100 leading-relaxed">
            ...
            performance. Only the system-generated test responses are recorded
            for operational purposes, without linking them to personal
            identifiers.
          </p>
        </div>
        ...
        >
          ...
          <p class="text-gray-700 dark:text-gray-100 leading-relaxed">
            ...
            operations, maintenance, or legal compliance. All shared data is
            subject to strict confidentiality and security measures.
          </p>
        </div>
